    ...
    return (
        <div className="guides-wrapper" >
            ...
            <div className="guides-container" >
                ...
                <a className="guides-image-link" href="#" title='photo related to the article'  >
                    <Image src="https://picsum.photos/350/127?1" alt="photo related to the guide" className="bestOf-image" />
                    <span className="guides-text">
                        bite
                    </span>
                </a>
                <a className="guides-image-link" href="#" title='photo related to the article'  >
                    <Image src="https://picsum.photos/350/127?2" alt="photo related to the guide" className="bestOf-image" />
                    <span className="guides-text">
                        newcomers guide
                    </span>
                </a>
                <a className="guides-image-link" href="#" title='photo related to the article'  >
                    <Image src="https://picsum.photos/350/127?3" alt="photo related to the guide" className="bestOf-image" />
                    <span className="guides-text">
                        summer guide
                    </span>
                </a>
